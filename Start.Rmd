...
# load("~/covid19dashboard/testforknit.RData")
```
...
<!-- ```{r plotBLR} -->
<!-- ggplotly(mitigationsplot_blvergleich, tooltip = c("x", "y", "text")) %>% # , width=800, height=400 -->
<!--   config(displayModeBar = FALSE, responsive=TRUE) -->
...
<!-- <div style = "width:99%; height:ato; margin: 0px; padding-right:2rem;"> -->

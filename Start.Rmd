...
```{r indicatorIncProj}
indicatorIncProj <- bl_projektionen %>% filter(Bundesland=="Gesamt") %>% pull(`Inzidenz<100 bei R(t) aktuell`)
if(indicatorIncProj=="nie") {
  indicatorIncProj <- "Inzidenz steigt!"
}
valueBox(value=indicatorIncProj,
         caption=paste0("Datum, bei dem mit aktuellem R-Wert die Sieben-Tage-Inzidenz den Zielwert 100 unterschreitet. \n unter 165: ",
                        bl_projektionen %>% filter(Bundesland=="Gesamt") %>% pull(`Inzidenz<165 bei R(t) aktuell`)#,
                        # ",\n unter 10: ",

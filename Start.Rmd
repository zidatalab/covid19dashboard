...
```{r indicatorIncProj}
indicatorIncProj <- bl_projektionen %>% filter(Bundesland=="Gesamt") %>% pull(`Inzidenz<35 bei R(t) aktuell`)
if(indicatorIncProj=="nie") {
  indicatorIncProj <- "Inzidenz steigt!"
}
valueBox(value=indicatorIncProj,
         caption=paste0("Datum, bei dem mit aktuellem R-Wert die Sieben-Tage-Inzidenz den Zielwert 35 unterschreitet. \n unter 50: ",
                        bl_projektionen %>% filter(Bundesland=="Gesamt") %>% pull(`Inzidenz<50 bei R(t) aktuell`),
                        ",\n unter 10: ",

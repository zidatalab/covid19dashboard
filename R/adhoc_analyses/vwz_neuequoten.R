...
ggplot(error_vwz_abw, aes(x=day, y=Abweichung)) +
  ...
  ylim(-100, 100) +
  labs(title="Modellfit", subtitle=paste0("neue ITS-Quoten, Infektdauer: ", infektperiode, ", Tage auf ITS: ", icu_days, ", Tage von Meldung bis ITS: ", infekt2icudays)) +
  geom_smooth()

ggplot(vorwarnzeitergebnis,
                      aes(x=date, y=VWZ)) +
  geom_line(size=2, col=zi_cols("zigreen")) +
  ylim(0, 181) +
  labs(title="Zi-Vorwarnzeit im Zeitverlauf",x="Datum",y="Vorwarnzeit", 
       subtitle=paste0("neue ITS-Quoten, Infektdauer: ", infektperiode, ", Tage auf ITS: ", icu_days, ", Tage von Meldung bis ITS: ", infekt2icudays)) +
  theme_minimal() +
...
ggplot(error_vwz_abw, aes(x=day, y=Abweichung)) +
  geom_point(alpha=0.1) +
  ylim(-100, 100) +
  labs(title="Modellfit", subtitle=paste0("alte ITS-Quoten, Infektdauer: ", infektperiode, ", Tage auf ITS: ", icu_days, ", Tage von Meldung bis ITS: ", infekt2icudays)) +
  geom_smooth()
...
ggplot(vorwarnzeitergebnis,
  ...
  ylim(0, 181) +
  labs(title="Zi-Vorwarnzeit im Zeitverlauf",x="Datum",y="Vorwarnzeit",
       subtitle=paste0("alte ITS-Quoten, Infektdauer: ", infektperiode, ", Tage auf ITS: ", icu_days, ", Tage von Meldung bis ITS: ", infekt2icudays)) +
  theme_minimal() +
  scale_x_date(date_labels = "%d.%m.", breaks="2 months") +
  theme(legend.position='none') +
  theme(panel.grid.major.x = element_blank(), panel.grid.minor.x = element_blank())
...
ggplot(mycoeffs_df, aes(x=id, y=coeff, group=ii, col=ii)) +
  geom_line() +

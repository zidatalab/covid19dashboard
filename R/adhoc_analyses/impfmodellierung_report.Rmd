...
# 
ann_text <- data.frame(kw = 36.5, IZ_Auslastung = 40, lab = "21.9.", szenario="IZ Regelbetrieb", Verteilungsszenario="Linearer Anstieg der Produktion in Q2")
output.plot1kw <- output %>%
  ...
  ylim(0, NA) +
  scale_y_continuous(breaks = c(100,200,400,600)) +
  geom_hline(yintercept=100,  linetype="dashed") + 
  geom_vline(xintercept=38) +
  labs(color="", x="KW", y="Auslastung der Impfzentren in %")+
...
```{r outputplot3, warning=FALSE, echo=FALSE}
# output.plot3
```

...
DT::datatable(bl_projektionen,
              ...
              options = list(paging = FALSE,
                             pageLength=20,
                             columnDefs = list(list(className = 'dt-center', targets = 3:7),
                                               ...
                                               list(visible = FALSE, targets = 10),
                                               list(orderData = 11, targets = 8),
                                               list(visible = FALSE, targets = 11)#,
                                               # list(orderData = 12, targets = 6),
                                               # list(visible = FALSE, targets = 12),
                                               # list(orderData = 13, targets = 9),
...
DT::datatable(kreise_projektionen %>% select(-`AGS (num)`, -Vorwarnzeit_ROR),
              ...
              options = list(paging = TRUE,
                             columnDefs = list(list(className = 'dt-center', targets = c(3, 5:8)),

...
Derzeit werden drei Impfstoffe zur Verhinderung einer COVID-19-Erkrankung eingesetzt ("Tozinameran" von Biontech/Pfizer, "mRNA-1273" von Moderna sowie "AZD1222" von AstraZeneca). Alle drei Impfstoffe setzen zwei verabreichte Impfdosen (mit unterschiedlichen Abständen) für einen vollständigen Impfschutz voraus.\
...
*Das RKI hat die bereitgestellten Informationen zu den erfolgten Impfungen verändert. Wir arbeiten an der Überarbeitung der hier berichteten Kennzahlen.*

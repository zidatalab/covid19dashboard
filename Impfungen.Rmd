...
Derzeit werden drei Impfstoffe zur Verhinderung einer COVID-19-Erkrankung eingesetzt ("Comirnaty" von Biontech/Pfizer, "mRNA-1273" von Moderna sowie "Vaxzevria" von AstraZeneca). Alle drei Impfstoffe setzen zwei verabreichte Impfdosen (mit unterschiedlichen Abständen) für einen vollständigen Impfschutz voraus.\
